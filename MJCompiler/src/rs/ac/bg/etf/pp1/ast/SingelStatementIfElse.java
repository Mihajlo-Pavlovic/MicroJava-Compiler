...
public class SingelStatementIfElse extends SingelStatement {
    ...
    public SingelStatementIfElse (IfCondition IfCondition, Statement Statement, Else Else, Statement Statement1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingelStatementIfElse(\n");
